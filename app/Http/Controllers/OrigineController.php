...
class OrigineController extends Controller
{
    ...
    public function index(){ 
    	...
    	return view('origine.index', compact('bulletins'));
    }


    // returns bp created by mandataire
     public function indexOrigineMandataire($id){
      ...
      ->where('dc_bulletin_pesage.bp_validerDirMin', '0')
     ...
     public function indexOrigineExportateur($id){
     ...
     public function indexOrigineGuichet($id){
    ...
    // returns Bp creation form
     ...
     // save bp to DB
      ...
      $data['bp_validerDirMinPar'] = 0;
        ...
        //code BpUnique
        $guich = DB::table('z_guichets')->select('guichet_code')->where('guichet_num', $request->guichet)->first();

        $data['bp_numeroUnique'] = $guich->guichet_code;
    ...
    public function expValidate(Request $request, $id)
    {
    ...
    public function divminValidate(Request $request, $id)
    {
    ...
    public function comexValidate(Request $request, $id)
    {
